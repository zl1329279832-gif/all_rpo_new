...
public class FriendController {
    ...
    @PostMapping("/add")
    public Result<Void> addFriend(HttpServletRequest request, @Valid @RequestBody AddFriendDTO dto) {
    ...
    @PostMapping("/accept")
    public Result<Void> acceptFriend(HttpServletRequest request, @RequestParam Long friendId) {
        Long userId = (Long) request.getAttribute("userId");
    ...
    @PostMapping("/reject")
    public Result<Void> rejectFriend(HttpServletRequest request, @RequestParam Long friendId) {
        Long userId = (Long) request.getAttribute("userId");
    ...
    public Result<Void> removeFriend(HttpServletRequest request, @RequestParam Long friendId) {
        Long userId = (Long) request.getAttribute("userId");
