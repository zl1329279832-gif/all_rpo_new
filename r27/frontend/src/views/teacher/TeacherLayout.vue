...
const activeMenu = computed(() => {
  if (route.path.includes('/courses')) return '/teacher/courses'
  if (route.path.includes('/assignments')) return '/teacher/assignments'
  return '/teacher/courses'
})

const currentPage = computed(() => {
  if (route.path.includes('/courses')) return '课程管理'
